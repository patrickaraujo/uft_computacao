...
Por ser uma rede é descentralizada, toda vez que uma transação é feita essa rede é atualizada, por essa razão é que cada transação leva um tempo para ser efetuada. Esse processo se chama mineração, onde cada transação passa pelos mineradores onde a operação vai ser validada e registrada.
